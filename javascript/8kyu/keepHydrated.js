...
function litres(time) {
    ...
    const multiply = time * 0.5; //Mengalikan param dengan 0.5
    const floor = Math.floor(multiply); //Membulat bawahkan hasil perkalian sebelumnya dengan metode Math.floor();
