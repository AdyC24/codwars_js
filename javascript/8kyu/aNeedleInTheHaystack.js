...
function findNeedle(haystack) {
  ...
  const index = haystack.indexOf("needle"); //Gunakan method "indexOf()" untuk mencari lokasi array di dalam index
  const stmnt = `found the needle at position ${index}`; //Buat statment yang akan diinisiasikan
